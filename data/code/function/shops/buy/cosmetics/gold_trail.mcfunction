execute if entity @s[tag=cosmetic.gold_trail] run return run tellraw @s {"text": "You already bought that cosmetic","color": "red"}
execute if entity @s[tag=cosmetic.disabled.gold_trail] run return run tellraw @s {"text": "You already bought that cosmetic","color": "red"}
...
tellraw @s {"text": "Purchased the Gold Trail cosmetic!","color": "green"}
tag @s add cosmetic.gold_trail
